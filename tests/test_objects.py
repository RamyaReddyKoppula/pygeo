...
def test__point_equal__given_two_equal_Rays__return_true():
    R1 = Ray(Point((0,1,2)), Point((1,2,1)))
    R2 = Ray(Point((0,1,2)), Point((1,2,1)))
    assert R1 == R2 

def test__point_equal__given_two_equal_Sphere__return_true():
    S1 = Sphere(Point((0,1,2)), 25)
    S2 = Sphere(Point((0,1,2)), 25)
    assert S1 == S2 
